...
function comprobarResultados() {
    ...
    ganar = false;
    let personaGanadora = "";
    if (celdas[0].classList.value != "cell" && celdas[0].classList.value == celdas[1].classList.value && celdas[0].classList.value == celdas[2].classList.value && celdas[0].classList.value == celdas[3].classList.value) {
    ...
    if (celdas[4].classList.value != "cell" && celdas[4].classList.value == celdas[5].classList.value && celdas[4].classList.value == celdas[6].classList.value && celdas[4].classList.value == celdas[7].classList.value) {
    ...
    if (celdas[8].classList.value != "cell" && celdas[8].classList.value == celdas[9].classList.value && celdas[8].classList.value == celdas[10].classList.value&& celdas[8].classList.value == celdas[11].classList.value) {
        if (celdas[8].classList.value == "turn-cell-o") {
            personaGanadora = "Ha ganado el circulo"
        }
        if (celdas[8].classList.value == "turn-cell-x") {
            personaGanadora = "Ha ganado la cruz"
        }
        ganar = true;
    }
    if (celdas[12].classList.value != "cell" && celdas[12].classList.value == celdas[13].classList.value && celdas[12].classList.value == celdas[14].classList.value&& celdas[12].classList.value == celdas[15].classList.value) {
        if (celdas[12].classList.value == "turn-cell-o") {
            personaGanadora = "Ha ganado el circulo"
        }
        if (celdas[12].classList.value == "turn-cell-x") {
            personaGanadora = "Ha ganado la cruz"
        }
        ganar = true;
    }
    if (celdas[0].classList.value != "cell" && celdas[0].classList.value == celdas[4].classList.value && celdas[0].classList.value == celdas[8].classList.value && celdas[0].classList.value == celdas[12].classList.value) {
        if (celdas[0].classList.value == "turn-cell-o") {
            personaGanadora = "Ha ganado el circulo"
        }
        if (celdas[0].classList.value == "turn-cell-x") {
    ...
    if (celdas[1].classList.value != "cell" && celdas[1].classList.value == celdas[5].classList.value && celdas[1].classList.value == celdas[9].classList.value && celdas[1].classList.value == celdas[13].classList.value) {
    ...
    if (celdas[2].classList.value != "cell" && celdas[2].classList.value == celdas[6].classList.value && celdas[2].classList.value == celdas[10].classList.value && celdas[2].classList.value == celdas[14].classList.value) {
    ...
    if (celdas[3].classList.value != "cell" && celdas[3].classList.value == celdas[7].classList.value && celdas[3].classList.value == celdas[11].classList.value && celdas[3].classList.value == celdas[15].classList.value) {
    ...
    if (celdas[0].classList.value != "cell" && celdas[0].classList.value == celdas[5].classList.value && celdas[0].classList.value == celdas[10].classList.value && celdas[0].classList.value == celdas[15].classList.value) {
        if (celdas[0].classList.value == "turn-cell-o") {
            personaGanadora = "Ha ganado el circulo"
        }
        if (celdas[0].classList.value == "turn-cell-x") {
    ...
    if (celdas[3].classList.value != "cell" && celdas[3].classList.value == celdas[6].classList.value && celdas[3].classList.value == celdas[9].classList.value && celdas[3].classList.value == celdas[12].classList.value) {
        if (celdas[3].classList.value == "turn-cell-o") {
            personaGanadora = "Ha ganado el circulo"
        }
        if (celdas[3].classList.value == "turn-cell-x") {
...
function seguirJugandoMaquina() {
    let randomizador = Math.floor(Math.random() * (15 - 1 + 1) + 1);
    ...
    while (comprobador == false) {
        ...
        if (cambiarNumero) {
            randomizador = Math.floor(Math.random() * (15 - 1 + 1) + 1);
        } else {
            comprobador = true;
        }
    }
